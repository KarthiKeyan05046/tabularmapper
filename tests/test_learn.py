...
from tabularmapper import engine as bm, bank_preset            # noqa: E402
from tabularmapper.learn import LearnStore, learn_from_result  # noqa: E402
...
def test_harvest_folder(tmp_path):
    import shutil
    from tabularmapper.ai_matcher import OpenAICompatibleMatcher
    from tabularmapper.learn import harvest_folder
